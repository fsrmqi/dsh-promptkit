...
| --- | --- | --- |
| `window.localStorage` | Favorites / history persistence (configurable prefix, isolated from other plugins) | Clear localStorage to wipe, no server-side persistence |
