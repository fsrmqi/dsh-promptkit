...
const MODULES = [
  ...
  ['src/lib/enhance-output.js', 'dsh-promptkit 模型输出协议'],
  ['src/lib/diagnosis-findings.js', 'dsh-promptkit 诊断缺口分类与完整草稿键'],
  ...
  ['src/adapters/dsh-session-enhancer.js', 'dsh-promptkit adapter: DshSessionEnhancer'],
  ...
  ['src/ui/quick-enhancer/use-onboarding-progress.js', 'QuickEnhancer 首次体验进度'],
  ['src/ui/quick-enhancer/use-draft-guard.js', 'QuickEnhancer 草稿提交守卫'],
  ['src/ui/quick-enhancer/use-auto-enhance.js', 'QuickEnhancer 自动增强与单次发送'],
  ['src/ui/quick-enhancer/use-enhancement-flow.js', 'QuickEnhancer 增强事务与流式状态'],
  ['src/ui/quick-enhancer/use-panel-dismiss.js', 'QuickEnhancer 浮层关闭与宿主事件隔离'],
  ...
  ['src/ui/quick-enhancer/file-menu.js', 'QuickEnhancer 子组件: VariableFillNode（模板变量补值面板）'],
